...
def valid_listing_data():
    ...
    return {
        "id": "fb-123456789",
        "listing": {
            "price": {"amount": 425000, "currency": "USD"},
            "propertyType": "House",
            "datePosted": "2025-01-20T15:30:00Z",
            "location": {
                "latitude": 33.4484,
                "longitude": -112.0740,
                "address": {"city": "Phoenix", "state": "AZ", "zipCode": "85001"},
            },
            "seller": {
                "name": "Alice Johnson",
                "id": "fb-seller-123",
                "contactInfo": {"phone": "555-0123", "email": "alice.j@email.com"},
            },
        },
        "engagement": {"views": 150, "saves": 25, "inquiries": 10},
    }
...
async def test_high_engagement_score(parser, valid_listing_data):
    ...
    valid_listing_data["engagement"] = {"views": 500, "saves": 100, "inquiries": 50}
...
async def test_low_engagement_score(parser, valid_listing_data):
    ...
    valid_listing_data["engagement"] = {"views": 10, "saves": 1, "inquiries": 0}
