...
async def test_successful_scrape(scraping_engine, mock_response):
    ...
    await scraping_engine.metrics_collector.increment_counter.assert_called_with("successful_scrapes")
...
async def test_error_handling(scraping_engine):
    ...
    await scraping_engine.metrics_collector.increment_counter.assert_called_with("scraping_errors")
...
async def test_custom_parser(scraping_engine, mock_response):
    ...
    result = await scraping_engine.scrape(
        "http://example.com",
