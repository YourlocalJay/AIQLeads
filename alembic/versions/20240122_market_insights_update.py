...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            postgresql.ENUM(
                "pending", "completed", "failed", "refunded", name="transaction_status"
            ),
            nullable=False,
        ...
        sa.Column(
            "type",
            postgresql.ENUM(
                "subscription", "one_time", "refund", name="transaction_type"
            ),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "tier",
            postgresql.ENUM("basic", "premium", "enterprise", name="subscription_tier"),
            nullable=False,
        ),
        sa.Column(
            "status",
            postgresql.ENUM(
                "active", "cancelled", "expired", "pending", name="subscription_status"
            ),
            nullable=False,
            server_default="pending",
        ),
    ...
    op.create_index(
        "idx_subscriptions_dates", "subscriptions", ["start_date", "end_date"]
    )
