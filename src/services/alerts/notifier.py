...
class AlertService:
    ...
    def _send_slack(self, level: AlertLevel, message: str, details: Dict[str, Any]) -> None:
        payload = {
    ...
    def _trigger_pagerduty(self, level: AlertLevel, message: str, details: Dict[str, Any]) -> None:
        payload = {
            "incident": {
                "title": message,
