...
class Docaider:
    ...
    async def generate_docs(
        self, 
        module: Any, 
        metadata: Optional[DocaiderMetadata] = None
    ) -> DocaiderMetadata:
...
"""
        ...
        for class_name, class_data in doc_content.get('classes', {}).items():
            ...
            markdown += f"**Docstring:** {class_data['docstring'] or 'No docstring'}\n\n"
            ...
            with open(doc_file, 'r') as f:
                ...
                if query.lower() in content:
                    ...
                    if metadata:
                        ...
                        if (not tags or any(tag in metadata.tags for tag in tags)) and \
