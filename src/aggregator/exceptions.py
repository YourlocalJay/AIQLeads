...
class ProxyError(ScraperError):
    ...
    def __init__(self, message: str = "Proxy operation failed", proxy: Optional[str] = None, **kwargs):
        kwargs['proxy'] = proxy
        super().__init__(message, **kwargs)
...
class ValidationError(ScraperError):
    ...
    def __init__(self, message: str = "Data validation failed", field: Optional[str] = None, **kwargs):
        kwargs['field'] = field
        super().__init__(message, **kwargs)
...
class PaginationError(ScraperError):
    ...
    def __init__(self, message: str = "Pagination failed", page: Optional[int] = None, **kwargs):
        kwargs['page'] = page
        super().__init__(message, **kwargs)
