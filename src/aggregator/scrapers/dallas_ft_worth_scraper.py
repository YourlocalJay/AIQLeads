...
class DallasFtWorthScraper(BaseScraper):
    ...
    async def search(
        ...
        **kwargs,
        ...
        try:
            logger.info(
                f"Starting Dallas/Ft. Worth search for location: {location}, radius: {radius_km} km"
            )
        ...
        return [
            {
                ...
                "agentEmail": "charlie.adams@example.com",
                "agentPhone": "+5555555555",
                "price": 450000,
            },
            {
                "agentName": "Dana Lee",
                "agentEmail": "dana.lee@example.com",
                "agentPhone": "+6666666666",
                "price": 550000,
            },
        ]
