...
class AustinScraper(BaseScraper):
    ...
    async def search(self, location: str = "Austin", radius_km: float = 50.0, include_subregions: bool = True, **kwargs) -> List[LeadCreate]:
        """
    ...
    async def _mock_api_call(self, location: str, radius_km: float) -> List[dict]:
        ...
        return [
            {"agentName": "Alice Johnson", "agentEmail": "alice.johnson@example.com", "agentPhone": "+3333333333", "price": 700000},
            {"agentName": "Bob Carter", "agentEmail": "bob.carter@example.com", "agentPhone": "+4444444444", "price": 800000},
        ]
