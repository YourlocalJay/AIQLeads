...
async def leads_endpoint(
    ...
    try:
        ...
        await handle_client_connection(websocket, client_id, regions, min_score, permissions)
            ...
            while True:
                ...
                if competitor_activities:
                    await websocket.send_json({
                        ...
                        "activities": [activity.dict() for activity in competitor_activities]
                    })
                
                # Update analytics
                analytics.record_events_sent(session_id, len(market_events) + len(competitor_activities))
